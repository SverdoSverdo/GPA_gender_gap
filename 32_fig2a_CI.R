...
# function to extract expected differences in GPA given the interactions
int_gain <- function(fit) {
...
clusterExport(cl, varlist = c("int_gain","data"), envir = environment())
...
# Save
write.csv(result_df, "fig2a_CI.csv", row.names = FALSE)
